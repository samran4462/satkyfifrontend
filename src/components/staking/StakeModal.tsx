...
export function StakeModal({ isOpen, onClose, balances }: StakeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-0">
      ...
      <div className="relative w-full max-w-md bg-surface border border-surface-elevated rounded-2xl shadow-[0_0_50px_rgba(124,58,237,0.15)] overflow-hidden flex flex-col max-h-[90vh]">
        {/* Header */}
              ...
              <div className="pt-4 border-t border-surface-elevated">
                ...
                {!isActuallyApproved ? (
                  ...
                  <button 
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-electric text-white font-bold hover:bg-bright-violet transition-colors disabled:opacity-50 disabled:hover:bg-electric flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(124,58,237,0.3)]"
                  >
